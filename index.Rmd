...
- ## **Visualizing probability distributions across bivariate cyclic temporal granularities_ **
...
<br>
<br>
### If certain days of the week are different for different months?
]
...
```{r effectoflevel1, out.width= "90%"}
```

For too many categories levels
- ridge plots should be avoided
- Quantile plots might be useful for comparing patterns
- Other involved methods of plotting useful for studying anomalies, outlier or multimodal behavior
---
class:  middle center
...
```{r effectofreverse1, out.width= "90%"}
```

Different mapping of cyclic granularities shift focus to different periodic behaviors
---
<!-- class:  middle center -->
...
```{r harmony}
```
### Good news! Only 13 out `r length(combn(6,2))` are harmonies 
]
---
