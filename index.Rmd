...
output:
  xaringan::moon_reader:
    ...
    css: ["libs/font-awesome/css/fontawesome-all.css", "xaringan-themer.css","libs/myremark.css", "timeline.css"]
...
.right-column[
`r par(mfrow = c(1, 2))`
```{r motivation4, fig.height=4.5}
```

```{r motivation5, fig.height=4.5}
```
]
...
<!-- SLIDE 6 -->
## Effect of number of levels on visualization
<!-- If certain  hours of the day are different between weekdays and weekends ? -->
```{r effectoflevel1, fig.height = 9}
...
```{r effectofreverse1, fig.height = 9}
```
