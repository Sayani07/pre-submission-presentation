...
- A new metric for automatic discovery of periodic patterns in time series <br><br>
- Clustering of residential Australian smart meter customers
]
---
...
.right-column[
```{r validate-household1, out.width="90%"}
