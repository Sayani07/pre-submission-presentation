...
---
# Project 2: Computation (Making underlying distribution more symmetric)

- NQT performed (explain NQT)

---
# Project 2: Computation (characterizing distributions through quantiles)

- Quantiles computed (refer to Rob's paper)
-  Percentiles of $v^*_{jk}$ are computed and stored in $q_{jk}$.

---
# Project 2: Computation (computing distances between quantiles)
...
---
# Project 2: Computation (defining $wpd$ using tuning parameter, within and between facet distances)
