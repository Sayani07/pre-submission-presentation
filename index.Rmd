...
- Visualizing probability distributions across bivariate cyclic temporal granularities (submitted to JCGS in September, 2020) <br><br>
- A new metric for automatic discovery of periodic patterns in time series <br><br> (draft prepared and incorporating comments from supervisors)
...
---
# Project 2: Normalization results (Permutation)
...
* search granularities `search_gran()`
* set of harmonies `harmony()`
* select and rank harmonies `select_harmonies()`
]
]

.right-column[
```{r rank-table, out.width="90%"}
```
]
---
#  Melbourne households example
